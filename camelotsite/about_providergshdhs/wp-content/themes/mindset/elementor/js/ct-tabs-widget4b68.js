( function( $ ) {
    ...
    var WidgetCTTabsExtraHandler = function( $scope, $ ) {
        $scope.find(".ct-tabs-extra .ct-tab-title").on("click", function(e){
            e.preventDefault();
            var target = $(this).data("target");
            var parent = $(this).parents(".ct-tabs-extra");
            parent.find(".ct-tabs-content .ct-tab-content").slideUp(300).removeClass('active');
            parent.find(".ct-tab-title").removeClass('active');
            $(this).addClass("active");
            $(target).slideDown(300).addClass('active');
        });
    };
    ...
    $( window ).on( 'elementor/frontend/init', function() {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/ct_tabs_extra.default', WidgetCTTabsExtraHandler );
